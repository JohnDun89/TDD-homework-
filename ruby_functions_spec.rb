...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_cube()
    cube_length_one = volume_of_cube(4)
    cube_length_two = volume_of_cube(7)
    assert_equal( 64, cube_length_one )
    assert_equal( 343, cube_length_two)

  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    radius_one = volume_of_sphere(4)
    radius_two = volume_of_sphere(12)
    assert_equal( 268.08, radius_one)
    assert_equal( 7238.23, radius_two)
